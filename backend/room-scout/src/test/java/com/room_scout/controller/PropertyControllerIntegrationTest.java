...
class PropertyControllerIntegrationTest {
        ...
        void givenValidProperty_whenCreateProperty_thenPropertyIsCreated() throws Exception {
                PropertyDTO newProperty = new PropertyDTO(null, "Test Property", "123 Test St", "Test Country",
                                "Test City",
                                "Hotel", null, null);
        ...
        void whenCreatePropertiesInBulk_thenPropertiesAreCreated() throws Exception {
                List<PropertyDTO> properties = List.of(
                                new PropertyDTO(null, "Property 1", "Address 1", "Country 1", "City 1", "Hotel", null,
                                                null),
                                new PropertyDTO(null, "Property 2", "Address 2", "Country 2", "City 2", "Resort", null,
                                                null));
        ...
        void givenNonExistentId_whenUpdateProperty_thenReturnNotFound() throws Exception {
                PropertyDTO updatedProperty = new PropertyDTO(999L, "Updated Property", "789 Updated St",
                                "Updated Country",
